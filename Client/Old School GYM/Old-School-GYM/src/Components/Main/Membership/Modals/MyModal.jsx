...
export default function MyModal({ visible, onClose }) {
    ...
    return (
      <div onClick={handleOnClose} class="fixed inset-0 bg-Primary-color bg-opacity-30 backdrop-blur-sm flex justify-center items-center z-10 px-5">
        ...
        <div className={"h-full px-3 pt-1 rounded-lg border-2 border-Dark-blue bg-white flex flex-col  overflow-hidden shadow-2xl"}>
          <h2 className={"text-black title-font mb-1 font-bold text-center sm:text-4xl text-2xl "}>NORMAL</h2>
